...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  update_failed: "Could not update your password. The reset link may have expired — please request a new one.",
};

export default function ResetPasswordForm({ error }: { error: string | null }) {
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border border-border bg-elevated px-4 py-2.5 pr-10 text-sm text-foreground placeholder:text-(--text-muted) outline-none transition-colors focus:border-accent focus:ring-1 focus:ring-accent"
          />
          <button
            type="button"
